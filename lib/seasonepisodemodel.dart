...
List<SeasonEpisodeModel> seasonEpisodeModelFromJson(String str) => List<SeasonEpisodeModel>.from(json.decode(str).map((x) => SeasonEpisodeModel.fromJson(x)));

String seasonEpisodeModelToJson(List<SeasonEpisodeModel> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
...
class SeasonEpisodeModel {
    ...
    factory SeasonEpisodeModel.fromJson(Map<String, dynamic> json) => SeasonEpisodeModel(
        id: json["id"],
        url: json["url"],
        name: json["name"],
        season: json["season"],
